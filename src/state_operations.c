...
//     return hash_table_is_in_hashed(state->visited_boards, board, board_compare_values, board->hash_value);
// }

// bool state_mark_current_as_visited(State* state)
// {
//     return hash_table_insert_hashed(state->visited_boards, state->current_board, board_compare_values, state->current_board->hash_value);
// }
